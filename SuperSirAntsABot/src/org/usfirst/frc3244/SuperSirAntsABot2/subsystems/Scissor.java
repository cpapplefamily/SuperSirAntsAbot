...
public class Scissor extends Subsystem {
	...
	public static final double CLIMB_FINNISED = 55;
	public static final double CLIMB = 80;
	public static final double SCALE = 72;
	public static final double SWITCH = 36;
	public static final double DOWN = 0;
	public static final double DRIVE_WITH_CUBE = 10;
 ...
 // member variables to support closed loop mode
  	...
  	private int m_CruiseVelocity = 2444;//2444 = 75% 
	private int m_Acceleration = 1500;
	private int m_CruiseVelocityClimb = 600;//2444 = 75% 
    ...
    //Set the PID Profile Slot and command talonSRX
    /**
     * 
     * @param height
     * @param isClimb
     */
    public void my_ScissorMotionMagic(double height, boolean isClimb) {
    	int talonIndex;
    	if(isClimb) {
    		for (talonIndex = 0; talonIndex < kMaxNumberOfMotors; talonIndex++) {
    	...
    	my_ScissorMotionMagic(height);
    }
    
    public void my_ScissorMotionMagic(double height) {
    	m_targetEncoderValue = clampEncoderValue(height * 877.714);
		    	...
		    	boolean enableMotionMagicSync=false;
		    	
		    	if((m_targetEncoderValue-m_motorLeft_Profile_Start_Pos)>0) { //If Positive Command
		    		if(syncError<0) { // Left is lagging
		    			System.out.println("Sync Error, Pos Dirrection, hold back Righ Motor "+ syncError);
		    			if(enableMotionMagicSync) {
				    		m_talons[kMotorLeft].configMotionCruiseVelocity(m_CruiseVelocity, Constants.kTimeoutMs);
				        	m_talons[kMotorRight].configMotionCruiseVelocity(m_CruiseVelocity, Constants.kTimeoutMs);
				    	}
		    		}
		    	}
    ...
    private double clampEncoderValue(double value) {
    	if(value > 18*4096) { //18 Rev at 4096 counts/rev
    		DriverStation.reportError("Scissor m_targetEncoderValue. Out of range MAX: " + value  + ">" + 18*4096, false);
    		return 18*4096;
    	}else if(value<0){
    ...
    private void debug() {
    	...
    	SmartDashboard.putNumber("Current Pos: ", currentPos / (877.714));
    	SmartDashboard.putNumber("Window Hi", window_Hi / (877.714));
    	SmartDashboard.putNumber("window Low", window_Low / (877.714));
