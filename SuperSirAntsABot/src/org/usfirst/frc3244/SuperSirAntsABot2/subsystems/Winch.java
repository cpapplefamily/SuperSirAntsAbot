...
public class Winch extends Subsystem {
	...
	public static final double TEST_ROTATIONS = 5;
	private boolean m_encoderZeroed = false;
    ...
    // member variables for Motors drive
   	...
   	private int m_CruiseVelocity = 187;
    ...
    public void my_WinchMotionMagic(double rotations) {
    ...
    public void my_zeroEncoders() {
		...
		m_encoderZeroed = true;
		
    }
    public boolean my_get_encoderZeroed() {
    	return m_encoderZeroed;
    }
