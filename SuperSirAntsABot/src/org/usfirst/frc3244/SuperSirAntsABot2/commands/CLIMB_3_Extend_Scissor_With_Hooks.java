 ...
 *
 */
public class CLIMB_3_Extend_Scissor_With_Hooks extends Command {

    public CLIMB_3_Extend_Scissor_With_Hooks() {
    ...
    protected void execute() {
    	Robot.scissor.my_ScissorMotionMagic(Robot.scissor.CLIMB);
    }
