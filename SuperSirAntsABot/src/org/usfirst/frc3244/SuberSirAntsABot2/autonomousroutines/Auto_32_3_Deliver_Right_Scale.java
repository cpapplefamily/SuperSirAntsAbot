 ...
 *
 */
public class Auto_32_3_Deliver_Right_Scale extends CommandGroup {

    public Auto_32_3_Deliver_Right_Scale() {
    	addParallel(new Wrist_Down(1));
    	addParallel(new ScissorToSetpoint(Robot.scissor.SCALE,true),5);
